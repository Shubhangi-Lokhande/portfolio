  ...
  return (
    <div name="home" className='h-auto w-full bg-gradient-to-b from-black via-black to-gray-400'>
        <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full md:flex-row'>
            ...
            {/*<h2 className='text-3xl font-Courgette text-white  font-semibold'>Front-End Developer Exploring Salesforce Administrator Opportunities</h2>*/}
                 <h2 className='text-3xl sm:text-2xl font-semibold text-white'>I'M a Front-End Developer<br/>Exploring Salesforce Administrator Opportunities</h2>
